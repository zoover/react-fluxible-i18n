...
let Localize = React.createClass({
  ...
  render: function() {
    return React.createElement('span', {}, I18n._localize(this.props.value, this.props.dateFormat ? {dateFormat: this.props.dateFormat} : this.props.options, this.props.locale));
  }
});
